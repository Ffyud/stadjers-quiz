    ...
    return (
      <div key={vraagData.id} className="vraagKader">
        <div className="vraagOpties">
          ...
          <ul>
            <li aria-label={vraagData.antwoord[0]} onClick={this.kiesAntwoord.bind(this)} data-vraag={vraagData.id} data-antwoord='1'>
              <span className='antwoordNummer'>1</span><span>{vraagData.antwoorden[0]}</span>
            </li>
            <li aria-label={vraagData.antwoord[1]} onClick={this.kiesAntwoord.bind(this)} data-vraag={vraagData.id} data-antwoord='2'>
              <span className='antwoordNummer'>2</span><span>{vraagData.antwoorden[1]}</span>
            </li>
            <li aria-label={vraagData.antwoord[2]} onClick={this.kiesAntwoord.bind(this)} data-vraag={vraagData.id} data-antwoord='3'>
              <span className='antwoordNummer'>3</span><span>{vraagData.antwoorden[2]}</span>
            </li>
            <li aria-label={vraagData.antwoord[3]} onClick={this.kiesAntwoord.bind(this)} data-vraag={vraagData.id} data-antwoord='4'>
